    ...
    try:
        ...
        for student_data in request.students:
            try:
                ...
                student_manager.insert_consensus_embedding(
                    student_id=student_data.student_id,
                    class_code=student_data.class_code,
    ...
    try:
        ...
        for student_data in request.students:
            try:
                ...
                student_manager.delete_student(student_data.student_id, student_data.class_code)
                deleted_count += 1
...
async def search_with_voting(request: SearchWithVotingRequest):
    ...
    try:
        ...
        top_matches = []
        for i, (student_id, distance) in enumerate(zip(search_results['ids'][0], search_results['distances'][0])):
